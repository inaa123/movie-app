...
function OverView({setIsClick, title, movieId, backdrop_path , overview}) { //Action에서 OverView movie={isClick} movie로 넘겼으니 {movie}를 받아온다. movie안엔 여러 객체가 담겨있다. 필요한거 뽑아서 사용
//overview는 줄거리임
